...
It has since gone through several improvements and rewriting, such that there is nothing left from the original version.
It's now in a stable state and serves as a base framework for the developements of MetaSim, MetaOptimalPath...

***Meta GUI***

[![Meta](\images\2020\02\Meta\MetaGUI.png?raw=true){:width="300px" }](\images\2020\02\Meta\MetaGUI.png)
